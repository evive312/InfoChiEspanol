    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.fragment_container_list, ListFragment.newInstance("attractions"))
                    .commit();
        }
    }

    private void showOnePaneLayout() {
        Fragment detailFragment = getSupportFragmentManager().findFragmentById(R.id.fragment_container_detail);
